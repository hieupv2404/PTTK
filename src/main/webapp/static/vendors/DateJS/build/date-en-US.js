...
(function () {
   ...
   /** 
	...
	for (var i = 0; i < dx.length; i++) {
		// Create constant resources Day Name variables. Example: Date.MONDAY or Date.MON
	...
	for (var j = 0; j < mx.length; j++) {
		// Create constant resources Month Name variables. Example: Date.MARCH or Date.MAR
