			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form:form modelAttribute="modelForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/shelf/save" method="POST">
							<form:hidden path="id" />
...
<script type="text/javascript">
	...
	function cancel() {
		window.location.href = '<c:url value="/shelf/list/"/>'
	}
</script>