	...
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<a href="<c:url value="/product-back-list/add"/>" class="btn btn-app"><i class="fa fa-plus"></i>Add</a>
					<a href="<c:url value="/product-back-detail/list"/>" class="btn btn-app"><i class="fa fa-forward"></i>Product Back Item</a>
					<div class="container" style="padding: 50px;">
						<%--@elvariable id="searchForm" type=""--%>
						<form:form modelAttribute="searchForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/product-back-list/list/1" method="POST">
							...
							<div class="form-group">
								<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
									...
									<button class="btn btn-success"><a href="<c:url value="/product-back-list/getAll/1"/>"  style="color: white">Get All</a></button>
						...
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<c:forEach items="${products}" var="product" varStatus="loop">
									...
									<td class=" "><a style="color: blue" href="<c:url value="/product-back-detail/code/${product.code }"/>">${product.code }</a></td>
									...
									<td class="text-center"><a href="<c:url value="/product-back-list/view/${product.id }"/>" class="btn btn-round btn-default">View</a></td>
									<td class="text-center"><a href="<c:url value="/product-back-list/edit/${product.id }"/>" class="btn btn-round btn-primary">Edit</a></td>
									...
									<td class="text-center"><a href="<c:url value="/product-back-detail/${product.id }/add"/>" class="btn btn-round btn-info">Add Item</a></td>
...
<script type="text/javascript">
	 function confirmDelete(id){
		 if(confirm('Do you want delete this record?')){
			 window.location.href = '<c:url value="/product-back-list/delete/"/>'+id;
		 }
	 }
	 function gotoPage(page){
		 $('#searchForm').attr('action','<c:url value="/product-back-list/list/"/>'+page);
		 $('#searchForm').submit();
	 }
