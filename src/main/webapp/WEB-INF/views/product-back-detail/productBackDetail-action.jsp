			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form:form modelAttribute="modelForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/product-back-detail/save" method="POST">
							<form:hidden path="id" />
...
<%--							</div>--%>
							...
							<div class="form-group">
								...
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="productStatusListId">Product Back<span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<c:choose>
...
<script type="text/javascript">
	...
	function cancel() {
		window.location.href = '<c:url value="/product-back-list/list"/>'
	}
