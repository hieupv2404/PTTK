...
<%--							</div>--%>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="productStatusList.code">Product Back List </label>
								<div class="col-md-6 col-sm-6 col-xs-12">
							...
							<div class="form-group">
								<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
									...
									<button class="btn btn-success"><a href="<c:url value="/product-back-detail/getAll/1"/>"  style="color: white">Get All</a></button>
					...
					<div class="table-responsive">
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<c:forEach items="${products}" var="product" varStatus="loop">
									...
									<td class="text-center"><a href="<c:url value="/product-back-detail/view/${product.id }"/>" class="btn btn-round btn-default">View</a></td>
									<td class="text-center"><a href="<c:url value="/product-back-detail/edit/${product.id }"/>" class="btn btn-round btn-primary">Edit</a></td>
						...
						<div class="table-responsive">
							<table class="table table-striped jambo_table bulk_action">
								...
								<td width="44px"></td>
								<td width="200.8px"></td>
								<td width="103.2px">Total</td>
								<td width="60px">${totalQty}</td>
								<td class="price" style="font-size: 14px" width="122.5px">${totalPriceOne }</td>
								<td class="price" style="font-size: 14px" width="129px">${totalPriceTotal }</td>
								<td></td>
								<td></td>
								<td></td>
								<td></td>
...
<script type="text/javascript">
	 function confirmDelete(id){
		 if(confirm('Do you want delete this record?')){
			 window.location.href = '<c:url value="/product-back-detail/delete/"/>'+id;
		 }
	 }
	 function gotoPage(page){
		 $('#searchForm').attr('action','<c:url value="/product-back-detail/list/"/>'+page);
		 $('#searchForm').submit();
	 }
