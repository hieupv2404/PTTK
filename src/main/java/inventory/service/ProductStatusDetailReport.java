...
public class ProductStatusDetailReport extends AbstractXlsxView{

	@Override
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		// TODO Auto-generated method stub
		String fileName = "product-status-detail-report"+System.currentTimeMillis()+".xlsx";
...
//			cell.setCellFormula("SUM(D2:D4)");
		title.createCell(1).setCellValue(" Product Status Detail");
